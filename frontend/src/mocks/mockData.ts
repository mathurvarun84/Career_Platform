...
if (!import.meta.env.DEV) {
  console.warn("mockData imported in production build — check import paths");
}
...
export const MOCK_ANALYSIS_RESULT: AnalysisResult = {
  ...
  gap: {
    ...
    priority_fixes: [
      {
        section: "skills",
        gap_reason: "Missing keyword for React in skills block",
        rewrite_instruction: "Add React to the primary skills line after TypeScript.",
      ...
      {
        section: "skills",
        gap_reason: "Typo: PostreSQL should be PostgreSQL",
        rewrite_instruction: "Fix spelling of PostgreSQL in skills section.",
      ...
      {
        section: "experience",
        gap_reason: "Passive voice, no impact metric in PaySprint bullets",
        rewrite_instruction:
          "Rewrite bullets with active voice and quantified outcomes (latency, throughput, or % improvements).",
      ...
      {
        section: "experience",
        gap_reason: "JD expects executive stakeholder communication",
        rewrite_instruction: "Surface leadership-facing communication and alignment work.",
        missing_keywords: ["stakeholder", "executive"],
        needs_change: true,
        gap_type: "evidence",
        requires_user_input: true,
        coaching_question:
...
Prepared to operate as a senior-level force multiplier in organizations with a high bar for technical depth and business impact.`,
  ...
  patches: [
    {
      patch_id: "patch-skills-kafka",
      gap_id: "skills-kafka",
      section: "skills",
      sub_entry_label: "",
      op: "insert_keyword",
      original_text: "PostgreSQL, Redis, AWS",
      replacement_text: "PostgreSQL, Redis, Kafka, AWS",
      keyword: "Kafka",
      risk: "safe",
      hallucination_risk: false,
      issue_detected: "Missing keyword for Kafka",
      fix_rationale: "JD lists Kafka as must-have",
      status: "pending",
      score_delta: 2,
    },
    {
      patch_id: "patch-skills-cicd",
      gap_id: "skills-cicd",
      section: "skills",
      sub_entry_label: "",
      op: "insert_keyword",
      original_text: "AWS, Docker",
      replacement_text: "AWS, Docker, CI/CD",
      keyword: "CI/CD",
      risk: "safe",
      hallucination_risk: false,
      issue_detected: "Missing CI/CD keyword",
      fix_rationale: "Improve keyword match for delivery tooling",
      status: "pending",
      score_delta: 2,
    },
  ],
...
export const mockProgressSnapshots: ProgressSnapshot[] = [
  ...
  {
    timestamp: "2024-11-01T10:08:00Z",
    ats_score: 67,
    jd_match: null,
    percentile: null,
    label: "After Fix #2",
...
export const mockCareerRecord: CareerMemoryEntry[] = [
  {
    id: "cr-001",
    session_id: "mock-session-001",
    gap_id: "gap-001",
    section: "experience",
    sub_label: "Flipkart - Senior Software Engineer",
    skill_category: "leadership",
    company: "Flipkart",
    generated_bullet:
      "• Mentored 3 junior engineers through architecture guidance and structured 1:1s, contributing to 2 internal promotions within 12 months.",
    raw_answer:
      "I ran weekly 1:1s with 3 juniors and helped 2 of them get promoted",
    timestamp: "2024-11-01T10:15:00Z",
  },
  {
    id: "cr-002",
    ...
    company: "Flipkart",
    generated_bullet:
      "• Built AI-powered incident response system reducing mean time to resolution from 45 minutes to 8 minutes.",
    raw_answer:
      "We built an AI system for incidents, cut resolution time by ~80%",
